...
export class Constantes {
    ...
    public static readonly iconFacebook = environment.iconSocialMediaFacebook;
    public static readonly iconInstagram = environment.iconSocialMediaInstagram;
    public static readonly iconTwitter = environment.iconSocialMediaTwitter;
